...
chatRouter.post("/", auth_middleware_1.protectAuth, chatController.chatWithMedAIController);
// Route to fetch all chats
chatRouter.get("/all", auth_middleware_1.protectAuth, chatController.fetchAllChatsForPatientController);
