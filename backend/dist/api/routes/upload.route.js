...
uploadRouter.post("/prescription", auth_middleware_1.protectAuth, upload.single("prescription"), uploadController.uploadPrescriptionController);
// Route to fetch all prescription
uploadRouter.get("/prescriptions", auth_middleware_1.protectAuth, uploadController.allPrescriptionController);
// Route to delete all prescription
uploadRouter.delete("/delete", auth_middleware_1.protectAuth, uploadController.allPrescriptionController);
